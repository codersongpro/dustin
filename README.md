...
`codersongpro` 계정에서 배포된 공개 웹 앱을 자동으로 모아 보여주는 페이지입니다.
...
페이지는 앱 이름, 저장소 설명, 배포 주소, 공개 저장소 주소, 최근 수정 시각만 사용합니다. 이메일, 실명, 위치, 프로필 사진, 커밋 작성자, 팔로워 정보는 수집하거나 표시하지 않습니다. GitHub 인증 토큰과 별도 데이터베이스도 사용하지 않습니다.
